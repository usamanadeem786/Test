...
class TestUpdateEmailTemplate:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                ...
                "<html><body><h1>Default</h1>FORGOT_PASSWORD, admin@bretagne.duchy https://example.auth.dev/reset</body></html>",
            ),
        ],
    )
    @pytest.mark.authenticated_admin(mode="session")
    ...
    async def test_invalid_template(
        ...
        assert response.headers["X-Auth-Error"] == "invalid_template"
