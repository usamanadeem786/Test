...
from auth.services.user_manager import RESET_PASSWORD_TOKEN_AUDIENCE
from auth.settings import settings
from auth.tasks import on_after_forgot_password
...
class TestGetResetPassword:
    async def test_missing_token(
        ...
        assert headers["X-Auth-Error"] == "missing_token"
