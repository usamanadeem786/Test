...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column("subject_user_id", auth.models.generics.GUID(), nullable=True),
        sa.Column("object_id", auth.models.generics.GUID(), nullable=True),
        sa.Column("object_class", sa.String(length=255), nullable=True),
        sa.Column("admin_user_id", auth.models.generics.GUID(), nullable=True),
        sa.Column("admin_api_key_id", auth.models.generics.GUID(), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column(
            "client_id", auth.crypto.encryption.StringEncryptedType(), nullable=False
        ),
        sa.Column(
            "client_secret",
            auth.crypto.encryption.StringEncryptedType(),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column("theme_id", auth.models.generics.GUID(), nullable=True),
        ...
        sa.Column("email_domain_id", auth.models.generics.GUID(), nullable=True),
        sa.Column("id", auth.models.generics.GUID(), nullable=False),
        sa.Column(
            "created_at",
            auth.models.generics.TIMESTAMPAware(timezone=True),
    ...
    op.create_table(
        ...
        sa.Column("webhook_id", auth.models.generics.GUID(), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("tenant_id", auth.models.generics.GUID(), nullable=False),
        sa.Column("oauth_provider_id", auth.models.generics.GUID(), nullable=False),
        sa.ForeignKeyConstraint(
            ["oauth_provider_id"],
    ...
    op.create_table(
        ...
        sa.Column(
            "access_token", auth.crypto.encryption.StringEncryptedType(), nullable=False
        ),
        sa.Column(
            "expires_at",
            auth.models.generics.TIMESTAMPAware(timezone=True),
        ...
        sa.Column(
            "refresh_token", auth.crypto.encryption.StringEncryptedType(), nullable=True
        ),
        sa.Column("account_id", sa.String(length=512), nullable=False),
        sa.Column("account_email", sa.String(length=512), nullable=True),
        sa.Column("oauth_provider_id", auth.models.generics.GUID(), nullable=False),
        sa.Column("user_id", auth.models.generics.GUID(), nullable=True),
        sa.Column("tenant_id", auth.models.generics.GUID(), nullable=False),
        sa.Column("id", auth.models.generics.GUID(), nullable=False),
        sa.Column(
            "created_at",
    ...
    op.create_table(
        ...
        sa.Column("user_id", auth.models.generics.GUID(), nullable=False),
        sa.Column("user_field_id", auth.models.generics.GUID(), nullable=False),
        sa.Column("id", auth.models.generics.GUID(), nullable=False),
        sa.Column(
            "created_at",
            auth.models.generics.TIMESTAMPAware(timezone=True),
    ...
    op.create_table(
        ...
        sa.Column("user_id", auth.models.generics.GUID(), nullable=False),
        sa.Column("permission_id", auth.models.generics.GUID(), nullable=False),
        sa.Column("from_role_id", auth.models.generics.GUID(), nullable=True),
        sa.Column("id", auth.models.generics.GUID(), nullable=False),
        sa.Column(
            "created_at",
            auth.models.generics.TIMESTAMPAware(timezone=True),
    ...
    op.create_table(
        ...
        sa.Column("oauth_provider_id", auth.models.generics.GUID(), nullable=False),
        sa.Column("oauth_account_id", auth.models.generics.GUID(), nullable=True),
        sa.Column("tenant_id", auth.models.generics.GUID(), nullable=False),
        sa.Column("id", auth.models.generics.GUID(), nullable=False),
        sa.Column(
            "created_at",
