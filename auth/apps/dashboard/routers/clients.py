...
from auth.apps.dashboard.forms.client import (
    ClientCreateForm,
    ClientLifetimesForm,
    ClientUpdateForm,
)
from auth.apps.dashboard.responses import HXRedirectResponse
from auth.crypto.jwk import generate_jwk
from auth.dependencies.admin_authentication import is_authenticated_admin_session
from auth.dependencies.client import get_client_by_id_or_404, get_paginated_clients
...
from auth.models import AuditLogMessage, Client
from auth.repositories import ClientRepository, TenantRepository
from auth.services.webhooks.models import ClientCreated, ClientDeleted, ClientUpdated
...
async def create_client(
    ...
    if await form_helper.is_submitted_and_valid():
        ...
        return HXRedirectResponse(
            ...
            headers={"X-Auth-Object-Id": str(client.id)},
        )
