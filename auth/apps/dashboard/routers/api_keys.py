...
from auth.apps.dashboard.forms.api_key import APIKeyCreateForm
from auth.apps.dashboard.responses import HXRedirectResponse
from auth.crypto.token import generate_token
from auth.dependencies.admin_api_key import (
...
from auth.models import AdminAPIKey, AuditLogMessage
from auth.repositories import AdminAPIKeyRepository
...
async def create_api_key(
    ...
    if await form_helper.is_submitted_and_valid():
        ...
        return templates.TemplateResponse(
            ...
            headers={"X-Auth-Object-Id": str(api_key.id)},
        )
