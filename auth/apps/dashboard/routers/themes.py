...
from auth.apps.dashboard.forms.theme import (
    ThemeCreateForm,
...
from auth.dependencies.theme import (
...
from auth.models import AuditLogMessage, Theme, User
from auth.repositories import TenantRepository, ThemeRepository, UserRepository
...
async def create_theme(
    ...
    if await form_helper.is_submitted_and_valid():
        ...
        return HXRedirectResponse(
            ...
            headers={"X-Auth-Object-Id": str(theme.id)},
        )
