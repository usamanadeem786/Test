...
from auth.schemas.well_known import OpenIDProviderMetadata
from auth.services.acr import ACR
from auth.services.response_type import ALLOWED_RESPONSE_TYPES
...
async def get_openid_configuration(
    ...
    configuration = OpenIDProviderMetadata(
        ...
        service_documentation=settings.auth_documentation_url,
    )
