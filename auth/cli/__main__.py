...
from auth.cli.quickstart import add_commands as quickstart_add_commands
...
app = typer.Typer(
    help="Commands to manage your Auth instance.", cls=CustomUnknownCommandGroup
)
app = quickstart_add_commands(app)

try:
    from auth.cli.admin import add_commands as admin_add_commands
