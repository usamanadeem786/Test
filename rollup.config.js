...
module.exports = [
  ...
  },
  {
    ...
    output: {
      file: './auth/static/code-editor.bundle.js',
      format: 'iife',
    },
    plugins: [
      nodeResolve(),
  ...
  },
  {
    ...
    output: {
      file: './auth/static/dependencies.bundle.js',
      format: 'iife',
    },
    plugins: [
      commonjs(),
